...
public class CollectionToDetailListener implements View.OnClickListener {
    private Context context;
    private List<Question> questions;
    private int position;

    public CollectionToDetailListener(Context context, List<Question> questions, int position) {
