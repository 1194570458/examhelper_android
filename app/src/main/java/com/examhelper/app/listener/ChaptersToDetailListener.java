...
public class ChaptersToDetailListener implements View.OnClickListener {
    private Context context;
    private List<Question> questions;
    private int position;

    public ChaptersToDetailListener(Context context, List<Question> questions, int position) {
...
//        List<Question> questions = iQuestionService.queryAllQuestions();
        ...
        intent.putExtra(IntentFlagConstant.PATTERN_TITLE, v.getContext().getResources().getString(R.string.special_examination));
        intent.putExtra(IntentFlagConstant.GET_WRONG_POSITION,0);
