...
import com.examhelper.app.listener.ErrorToDetailListener;

import java.util.List;

public class WrongShowAdapter extends BaseAdapter {
    private Context context;
    private List<Question> questions;

    public WrongShowAdapter(Context context, List<Question> questions) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rl_wrong.setOnClickListener(new ErrorToDetailListener(context,questions,position));
        return convertView;
    }
}
